...
export interface ApiProduitProduit extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Relation<
      ...
      'api::categorie.categorie'
    >
    DetailImage: Attribute.Media & Attribute.Required
    DetailDescription: Attribute.Text & Attribute.Required
    IllustrationImage: Attribute.Media
    FirstIllustrationImage: Attribute.Media & Attribute.Required
    DetailTitre: Attribute.String & Attribute.Required
    FicheTechnique: Attribute.Blocks & Attribute.Required
    cart_items: Attribute.Relation<
      'api::produit.produit',
      'oneToMany',
      'api::cart-item.cart-item'
